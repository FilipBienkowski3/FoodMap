    ...
    <div className="explore">
      ...
      <div className="explore__content">
        <div className="explore__search-wrap">
          <span className="material-symbols-outlined explore__search-icon">
            search
          </span>
          <input
          ...
          {filtered.map((user) => (
            <div key={user.id} className="explore__card">
              <img
                src={user.avatar}
                alt={user.name}
                className="explore__card-avatar"
              />
              ...
              <button
                ...
                onClick={() => {
                  trackEvent("explore", "view_user_profile", user.name);
                  nav(userRoute(user.id));
                }}
              >
                View Profile
              </button>
