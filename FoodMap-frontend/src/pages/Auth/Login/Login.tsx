    ...
    <div className="auth-page">
      <AuthCard>
        ...
        <div className="auth-page__form">
          ...
          <Button variant="primary" onClick={handleSubmit} disabled={loading} className="auth-page__submit">
        ...
        <div className="auth-page__social">
          <button className="auth-page__social-btn" onClick={handleGoogle}>
          ...
          <button className="auth-page__social-btn" onClick={() => {}}>
